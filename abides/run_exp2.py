"""
Experiment 2: Run Script
=========================
Convenience script to run the Experiment 2 LLM simulation and analysis.

Usage:
    python run_exp2.py [--seed SEED]
...
def main():
    parser = argparse.ArgumentParser(description='Run Experiment 2: LLM Market Baseline')
    parser.add_argument('--seed', type=int, default=12345, help='Random seed (default: 12345)')
    args = parser.parse_args()

    seed = args.seed
    log_dir = "exp2_seed{}".format(seed)

    print("=" * 60)
    print("Experiment 2: LLM Market Baseline")
    print("=" * 60)
