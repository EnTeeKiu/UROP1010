...
def main():
    parser = argparse.ArgumentParser(description='Run Experiment 3: Reasoning LLM Agent')
    parser.add_argument('--seed', type=int, default=12345, help='Random seed')
    args = parser.parse_args()

    seed = args.seed
    log_dir = f"exp3_reasoning_seed{seed}"

    print("=" * 60)
    print("Experiment 3: Reasoning LLM Baseline")
    print("=" * 60)
    print(f"Seed: {seed}")
